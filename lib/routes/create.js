...
module.exports = class createRoute {
    static register() {
        router.bindRoute({
            ...
            } else if (request.resourceConfig.primaryKey == "string") {
                const { JsonApiError } = require('../errorHandlers/JsonApiError.js')
                throw new JsonApiError({
                    status: 403,
                    code: 'EFORBIDDEN',
                    title: 'Missing client-generated ID',
                    detail: 'This resource requires a client-generated ID. Please provide an "id" in the request body.'
                })
            }
            ...
            const sanitisedData = await responseHelper.enforceSchemaOnObject(
                newResource, resourceConfig, request.inferredBaseUrl)
