...
class MemoryPromiseHandler extends Handler {
  ...
  #sortList(request, list) {
    ...
    list.sort((a, b) => {
      ...
      // Handle null/undefined - sort them to the end regardless of direction
      if (aVal == null && bVal == null) return 0
      if (aVal == null) return 1  // a is null, sort to end
      if (bVal == null) return -1 // b is null, sort to end
